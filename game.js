...
setTimeout(function() { window.location.hash = '#turn'; }, 500);
...
function fn(id) {
    if (arr_done.includes(id)) {
        ...
        arr_done.push(id);
        //console.log(parseInt(id[1] + id[2]));
        XO_Array[id] = img[35];

        if (((XO_Array["m00"] === 'X' && XO_Array["m01"] === 'X' && XO_Array["m02"] === 'X') ||
                (XO_Array["m00"] === 'O' && XO_Array["m01"] === 'O' && XO_Array["m02"] === 'O')) ||
            ((XO_Array["m00"] === 'X' && XO_Array["m10"] === 'X' && XO_Array["m20"] === 'X') ||
                (XO_Array["m00"] === 'O' && XO_Array["m10"] === 'O' && XO_Array["m20"] === 'O')) ||
            ((XO_Array["m00"] === 'X' && XO_Array["m11"] === 'X' && XO_Array["m22"] === 'X') ||
                (XO_Array["m00"] === 'O' && XO_Array["m11"] === 'O' && XO_Array["m22"] === 'O')) ||
            ((XO_Array["m01"] === 'X' && XO_Array["m11"] === 'X' && XO_Array["m21"] === 'X') ||
                (XO_Array["m01"] === 'O' && XO_Array["m11"] === 'O' && XO_Array["m21"] === 'O')) ||
            ((XO_Array["m02"] === 'X' && XO_Array["m11"] === 'X' && XO_Array["m20"] === 'X') ||
                (XO_Array["m02"] === 'O' && XO_Array["m11"] === 'O' && XO_Array["m20"] === 'O')) ||
            ((XO_Array["m02"] === 'X' && XO_Array["m12"] === 'X' && XO_Array["m22"] === 'X') ||
                (XO_Array["m02"] === 'O' && XO_Array["m12"] === 'O' && XO_Array["m22"] === 'O')) ||
            ((XO_Array["m10"] === 'X' && XO_Array["m11"] === 'X' && XO_Array["m12"] === 'X') ||
                (XO_Array["m10"] === 'O' && XO_Array["m11"] === 'O' && XO_Array["m12"] === 'O')) ||
            ((XO_Array["m20"] === 'X' && XO_Array["m21"] === 'X' && XO_Array["m22"] === 'X') ||
                (XO_Array["m20"] === 'O' && XO_Array["m21"] === 'O' && XO_Array["m22"] === 'O'))) {
